...
public class SanPhamAllAdapter extends RecyclerView.Adapter<SanPhamAllAdapter.MyViewHolder> {
    Context context;
    List<SanPhamMoi> array;

    public SanPhamAllAdapter(Context context, List<SanPhamMoi> array) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_all_san_pham,parent,false);
